      ...
      {canViewAdmin && (
        <View style={styles.section}>
          ...
          <View style={styles.adminGrid}>
            ...
            >
              <View style={[styles.adminIcon, { backgroundColor: "#E0F2F1" }]}>
                <Ionicons
            ...
            >
              <View style={[styles.adminIcon, { backgroundColor: "#F5F5F5" }]}>
            ...
            >
              <View style={[styles.adminIcon, { backgroundColor: "#FFF3E0" }]}>
                <Ionicons
                  name="document-text-outline"
                  size={24}
                  color="#E65100"
            ...
            >
              <View style={[styles.adminIcon, { backgroundColor: "#FBE9E7" }]}>
