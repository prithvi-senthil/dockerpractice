...
const CourseAssignmentApprovalScreen = ({ navigation }) => {
  ...
  const handleAcccept = async (courseId) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>📋 Course Assignments</Text>
        <Text style={styles.headerSubtitle}>
          Accept or reject course assignments
        </Text>
      </View>
